export const eventData = [
...

    {
        ...
        "roundDetails": {
            ...
            "round 2": ["Pictoword - A combination of pictures that form the movie name/ song name will be displayed on the screen.The participants must guess the word from the pictures they see on the screen into one word. Teams guessing the maximum number of movies qualify for the next round."],
...

    {
        ...
        "rules": ["The use of cell phones or any other electronic devices is not permitted", "No communication with the other teams will be entertained",
...

    {
        ...
        "smallDesc": "Lazzerena is a tag game which allows amateur video game lovers to experience war zone scenario in real life.",
        "fullDesc": "It is played with guns which emit infrared beams. Infrared sensitive sensors which are integ rat ed on jackets are worn by each player. The game will comprise of two teams and each team will try to knockout the opponent by firing on their respective sensors.",
...

    {
        ...
        "fullDesc": "We bring to you-  MISSION IMPOSSIBLE because the treasure is not easy to FIND. Isn't life a collection of weird quizzes with no answers to half the questions?",
        "roundDetails": {
            ...
            "round 2": ["A game that involves the use of your analytical and cryptic skills will be held, wherein the top 8 teams will qualify for the finale."],
            "round 3": ["The final round is a treasure hunt where team has to solve a set of clues which will lead them to the final treasure."]
        },
        ...
        "judgingCriteria": ["The judging criteria for the rounds will be mentioned during the event",
            "The decision of the judges is final and irrevocable."
        ],
        "contactDetails": [
            {
...

    {
        ...
        "smallDesc": "Open your eyes to a day when you're finally a celebrity not just in front of your mirror!",
...

    {
        ...
        "roundDetails": {
            ...
            "round2": ["This round is also a pen and paper test which consists of 20 questions that involve monitoring skills and visual clues to be answered in 20 minutes. The top 4 teams to clear round 2 will advance to round 3."],
        ...
        "judgingCriteria": ["The selection of teams for the final round will be based on the cutoff marks set by the judges",
